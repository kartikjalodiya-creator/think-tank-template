            ...
            <div key={cat.category} className="mb-16 last:mb-0">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {cat.items.map((item, i) => (
                  <div
                    key={item.label}
                    className="bg-card rounded-lg p-6 shadow-warm hover:shadow-warm-lg transition-all duration-300 hover:-translate-y-1 animate-fade-in-up"
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {galleryImages.map((img, i) => (
              <button
                ...
                className="group relative aspect-square rounded-lg overflow-hidden shadow-warm hover:shadow-warm-lg transition-all duration-300"
              >
